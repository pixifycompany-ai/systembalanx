...
export function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-40 hidden md:flex items-center justify-between gap-2 px-3 md:px-6 md:border-b md:border-border/40 md:bg-transparent md:backdrop-blur-xl"
      style={{
